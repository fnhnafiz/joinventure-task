function AboutClinTechno() {
  return (
    <section
      id="about"
      className="bg-[#1e283a] py-12 px-10 min-h-[400px] md:py-24"
    >
      <h2 className="text-[2.074rem] font-bold mb-8 text-blue-400 text-center tracking-tight">
        About Clin Technologies
      </h2>

      <div className="max-w-[1000px] mx-auto text-white text-[1rem] leading-[1.7] flex flex-col gap-[15px]">
        <p>
...
export default AboutClinTechno;
